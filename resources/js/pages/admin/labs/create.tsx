        ...
        <AppLayout>
            ...
            <div className="container mx-auto py-8 max-w-4xl">
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold">Créer un lab</h1>
                        <p className="text-muted-foreground">Ajouter un nouveau laboratoire</p>
                    </div>
                </div>
                ...
                <form onSubmit={submit}>
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Informations essentielles du lab
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div className="grid gap-2">
                                <Label htmlFor="cml_id">CML ID *</Label>
                                <Input
                                    id="cml_id"
                                    value={data.cml_id}
                                    onChange={(e) => setData('cml_id', e.target.value)}
                                    required
                                    placeholder="UUID du lab dans CML"
                                />
                                <InputError message={errors.cml_id} />
                            </div>
                            ...
                            <div className="grid gap-2">
                                ...
                                <Textarea
                                    ...
                                    rows={5}
                                />
                                <InputError message={errors.lab_description} />
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="grid gap-2">
                                ...
                                <Textarea
                                    ...
                                    rows={10}
                                    placeholder="Documentation markdown du lab..."
                                />
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    <div className="flex justify-end gap-4 mt-6">
                        ...
                        <Button type="submit" disabled={processing}>
                            {processing ? 'Création...' : 'Créer le lab'}
                        </Button>
                    </div>
                </form>
            </div>
